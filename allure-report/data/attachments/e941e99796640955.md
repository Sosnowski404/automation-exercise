...
- Name: api/delete-account.spec.ts >> /deleteAccount endpoint tests >> Negative: DELETE without email param should return 400
- Location: tests/api/delete-account.spec.ts:39:9
