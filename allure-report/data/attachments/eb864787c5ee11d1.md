...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Wrong param name instead of search_product
- Location: tests/api/search-product.spec.ts:112:9
