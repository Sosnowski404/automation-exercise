...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: SQL injection attempt as search_product param
- Location: tests/api/search-product.spec.ts:88:9
