...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: Special characters as email in update
- Location: tests/api/update-account.spec.ts:255:9
