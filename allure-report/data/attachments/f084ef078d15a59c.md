...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Multiple search_product values via comma
- Location: tests/api/search-product.spec.ts:161:9
