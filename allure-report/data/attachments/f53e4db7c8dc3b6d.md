...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: GET user detail with non-existing email should not return 200
- Location: tests/api/get-user-detail.spec.ts:62:9
