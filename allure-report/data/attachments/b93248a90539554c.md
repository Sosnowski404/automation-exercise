...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: Email as form data instead of query param
- Location: tests/api/get-user-detail.spec.ts:153:9
