...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Numeric path param on searchProduct
- Location: tests/api/search-product.spec.ts:152:9
