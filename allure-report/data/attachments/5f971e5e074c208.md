...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> API 6: POST To Search Product without search_product param should return 400
- Location: tests/api/search-product.spec.ts:34:9

# Error details

```
Error: Missing fields in SearchProductErrorResponse: [responseCode]
```
