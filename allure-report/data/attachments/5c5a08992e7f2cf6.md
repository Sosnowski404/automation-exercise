...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> API 14: GET user detail by email should return 200 and user object
- Location: tests/api/get-user-detail.spec.ts:8:9

# Error details

```
Error: Missing fields in CreateAccountResponse: [responseCode]
```
