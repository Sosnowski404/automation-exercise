...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with no params should return 400
- Location: tests/api/create-account.spec.ts:79:9
