...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with email + password (no name) should return 400
- Location: tests/api/create-account.spec.ts:70:9
