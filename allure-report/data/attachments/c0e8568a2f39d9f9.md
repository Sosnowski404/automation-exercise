...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account without company + mobile should return 400
- Location: tests/api/create-account.spec.ts:137:9
