...
- Name: api/delete-account.spec.ts >> /deleteAccount endpoint tests >> API 12: DELETE account with valid email and password should return 200
- Location: tests/api/delete-account.spec.ts:9:9
