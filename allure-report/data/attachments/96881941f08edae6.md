...
- Name: api/delete-account.spec.ts >> /deleteAccount endpoint tests >> Negative: DELETE without any params should return 400
- Location: tests/api/delete-account.spec.ts:51:9
