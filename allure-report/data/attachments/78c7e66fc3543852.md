...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> API 11: Create account without birth fields should return 201
- Location: tests/api/create-account.spec.ts:107:9
