...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> API 14: Birth fields are returned correctly
- Location: tests/api/get-user-detail.spec.ts:47:9
