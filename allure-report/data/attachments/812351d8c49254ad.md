...
- Name: api/products-list.spec.ts >> /productsList endpoint tests >> Negative: GET with special chars in query params
- Location: tests/api/products-list.spec.ts:98:9
