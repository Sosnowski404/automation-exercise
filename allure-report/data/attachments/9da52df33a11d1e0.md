...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: Update with no params should return 400
- Location: tests/api/update-account.spec.ts:124:9
