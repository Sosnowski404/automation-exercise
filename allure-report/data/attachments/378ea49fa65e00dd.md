...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with only name should return 400
- Location: tests/api/create-account.spec.ts:28:9
