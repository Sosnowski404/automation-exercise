...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: SQL injection in email param
- Location: tests/api/get-user-detail.spec.ts:92:9
