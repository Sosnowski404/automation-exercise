...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: GET user detail with special characters as email
- Location: tests/api/get-user-detail.spec.ts:86:9
