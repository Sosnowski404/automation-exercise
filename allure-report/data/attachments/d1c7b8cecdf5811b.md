...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account without firstname + lastname should return 400
- Location: tests/api/create-account.spec.ts:117:9
