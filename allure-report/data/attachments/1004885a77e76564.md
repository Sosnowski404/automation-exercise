...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Very long string as search_product param
- Location: tests/api/search-product.spec.ts:80:9
