...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: POST method on updateAccount should not return 200
- Location: tests/api/update-account.spec.ts:130:9
