...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: HTML/script injection as search_product param
- Location: tests/api/search-product.spec.ts:95:9
