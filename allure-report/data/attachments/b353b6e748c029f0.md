...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: Update non-existing account should not return 200
- Location: tests/api/update-account.spec.ts:86:9
