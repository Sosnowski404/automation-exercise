...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: GET user detail without email param should return 400
- Location: tests/api/get-user-detail.spec.ts:68:9
