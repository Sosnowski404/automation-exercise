...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> API 11: POST Create Account with all params should return 201
- Location: tests/api/create-account.spec.ts:8:9
