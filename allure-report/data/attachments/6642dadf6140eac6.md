...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: search_product as query param instead of form data
- Location: tests/api/search-product.spec.ts:122:9
