...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with name + email (no password) should return 400
- Location: tests/api/create-account.spec.ts:52:9
