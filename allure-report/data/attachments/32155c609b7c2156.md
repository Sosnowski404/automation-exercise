...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> API 5: Search with non-existing product returns empty array
- Location: tests/api/search-product.spec.ts:27:9
