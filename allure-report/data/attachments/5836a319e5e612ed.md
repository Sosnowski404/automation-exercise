...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: XSS injection in email param should not find user
- Location: tests/api/get-user-detail.spec.ts:98:9
