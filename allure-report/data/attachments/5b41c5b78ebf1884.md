...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> API 14: Response contains all expected user detail fields
- Location: tests/api/get-user-detail.spec.ts:22:9
