...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Special characters as search_product param
- Location: tests/api/search-product.spec.ts:73:9
