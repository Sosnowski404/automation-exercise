...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: Numeric value as email should not find user
- Location: tests/api/get-user-detail.spec.ts:120:9
