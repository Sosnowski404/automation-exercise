...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account without address fields should return 400
- Location: tests/api/create-account.spec.ts:125:9
