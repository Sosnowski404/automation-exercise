...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with name + password (no email) should return 400
- Location: tests/api/create-account.spec.ts:61:9
