...
- Name: api/delete-account.spec.ts >> /deleteAccount endpoint tests >> Negative: DELETE with valid email but wrong password should not return 200
- Location: tests/api/delete-account.spec.ts:63:9
