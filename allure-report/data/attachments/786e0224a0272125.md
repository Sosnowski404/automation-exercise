...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: Wrong param name instead of email
- Location: tests/api/get-user-detail.spec.ts:168:9
