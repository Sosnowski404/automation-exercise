...
- Name: api/brands-list.spec.ts >> /brandsList endpoint tests >> Negative: Random query params should be ignored and return 200
- Location: tests/api/brands-list.spec.ts:31:9
