...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: Update with wrong password for existing account
- Location: tests/api/update-account.spec.ts:245:9
