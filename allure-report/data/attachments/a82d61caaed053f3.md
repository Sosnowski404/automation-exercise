...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: Path traversal on getUserDetailByEmail resolves to different endpoint
- Location: tests/api/get-user-detail.spec.ts:192:9
