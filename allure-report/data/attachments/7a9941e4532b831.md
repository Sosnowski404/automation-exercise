...
```
Error: Unexpected fields in ProductsListResponse: [cloudflare_error, detail, error_category, error_code, error_name, footer, instance, owner_action_required, ray_id, retryable, status, timestamp, title, type, what_you_should_do, zone]
```
