...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Numeric value as search_product param
- Location: tests/api/search-product.spec.ts:59:9
