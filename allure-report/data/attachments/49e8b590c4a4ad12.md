...
- Name: api/delete-account.spec.ts >> /deleteAccount endpoint tests >> Negative: DELETE with non-existing email should not return 200
- Location: tests/api/delete-account.spec.ts:57:9

# Error details

```
Error: Missing fields in DeleteAccountResponse: [responseCode]
```
