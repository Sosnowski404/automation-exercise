...
- Name: api/update-account.spec.ts >> /updateAccount endpoint tests >> Negative: Update without password param should return 400
- Location: tests/api/update-account.spec.ts:116:9
