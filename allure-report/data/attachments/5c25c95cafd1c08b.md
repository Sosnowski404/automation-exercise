...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Empty string as search_product param
- Location: tests/api/search-product.spec.ts:66:9
