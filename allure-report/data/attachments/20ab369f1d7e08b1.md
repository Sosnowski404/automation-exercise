...
- Name: api/get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: DELETE method on getUserDetailByEmail should not return 200
- Location: tests/api/get-user-detail.spec.ts:144:9
