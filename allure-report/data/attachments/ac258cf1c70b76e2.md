...
- Name: api/create-account.spec.ts >> /createAccount endpoint tests >> Negative: Create account with duplicate email should return 400
- Location: tests/api/create-account.spec.ts:85:9
