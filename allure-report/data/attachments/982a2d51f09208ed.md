...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: GET method on searchProduct should return 405
- Location: tests/api/search-product.spec.ts:41:9
