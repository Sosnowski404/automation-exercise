...
- Name: api/search-product.spec.ts >> /searchProduct endpoint tests >> Negative: Path param appended to searchProduct
- Location: tests/api/search-product.spec.ts:132:9
