...
- Name: api\get-user-detail.spec.ts >> /getUserDetailByEmail endpoint tests >> Negative: GET user detail with invalid email format
- Location: tests\api\get-user-detail.spec.ts:80:9
